...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  if ($_POST['qty'] > 0) {
    ...
    $insertSQL = sprintf(
      ...
      GetSQLValueString($koneksi, 'T', "text"),
    ...
    if ($StokResult1) {
      $start = "COMMIT";
      $rs_start = mysqli_query($koneksi, $start) or die(mysqli_error($koneksi));
      pesanlink('Penambahan berhasil dilakukan', $actual_link);
    }
  } else {
            ...
            <tbody>
              ...
              do { ?>
                <tr>
                  ...
                  <td>
                    <p style="font-size:20px">(<?php echo $row_history['barcode']; ?>) <?php echo $row_history['namaproduk']; ?></p>
