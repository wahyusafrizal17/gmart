    ...
    <?php if ($totalRows_Penjualan > 0) { ?>
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <p><a href="report/penjualan.php?tgl1=<?= $tgl1; ?>&tgl2=<?= $tgl2; ?>&kasir=<?= $colname; ?>" target="_blank" class="btn btn-primary"><span class="fa fa-print"></span> Cetak Laporan</a> <a href="report/penjualanitem.php?tgl1=<?= $tgl1; ?>&tgl2=<?= $tgl2; ?>&kasir=<?= $colname; ?>" target="_blank" class="btn btn-info"><span class="fa fa-list"></span> Cetak Laporan Detail</a>
          ...
          <table width="100%" class="table table-striped table-bordered">
            ...
            do {
              ...
              $query_laba = sprintf("SELECT faktur, tanggal, hargadasar, harga, diskon, qty, (hargadasar * qty) as hd, (harga * qty) as hj, sum((((harga * qty) - (hargadasar * qty)))-diskon) as laba, ((harga * qty) - diskon) as sisadiskon  FROM `transaksidetail` WHERE faktur = %s GROUP BY faktur",  GetSQLValueString($koneksi, $row_Penjualan['kodefaktur'], "text"));
