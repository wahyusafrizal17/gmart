...
$query_barcode = sprintf("SELECT barcode.*, namaproduk, hargajual, hargadasar, kategori FROM barcode LEFT JOIN produk ON kodeproduk = barcode WHERE barcode = %s", GetSQLValueString($koneksi, $colname_barcode, "text"));
