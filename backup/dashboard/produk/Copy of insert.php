  ...
  <table width="100%"  class="table table-striped">
    <tr valign="baseline">
      ...
      <div class="row">
		...
		?> value="<?php echo $tampilkan; ?>" size="32" class="form-control" id="kodeproduk" required/>      
          </div>
          </div> <!-- col -->   
      </div><!-- row -->
      </td>
    ...
    <tr valign="baseline">
      <td><div align="left"><strong>Nama Produk*</strong></div>
          <input type="text" name="namaproduk" value="" size="32" class="form-control" id="namaproduk" required autofocus/></td>
    </tr>
    <tr valign="baseline">
      <td><div align="left"><strong>Harga Dasar*</strong></div>
          <input type="text" name="hargadasar" value="" size="32" class="form-control"  id="tanpa-rupiah" required/></td>
    </tr>
    <tr valign="baseline">
      <td><div align="left"><strong>Harga Jual*</strong></div>
          <input type="text" name="hargajual" value="" size="32" class="form-control"  id="tanpa-rupiah2" required/></td>
    </tr>
    <tr valign="baseline">
      <td><div align="left"><strong>Satuan*</strong></div>
          <input type="text" name="satuan" value="" size="32" class="form-control" required/></td>
    </tr>
    <tr valign="baseline">
      <td><div align="left"><strong>Stok Awal*</strong></div>
          <input type="number" name="stok" value="" size="32" class="form-control" required/></td>
    </tr>
    <tr valign="baseline">
      <td><div align="left"><strong>Detail Produk</strong></div>
      <textarea name="deskproduk" cols="50" rows="5" class="form-control" ></textarea>      </td>
    </tr>
    <tr valign="baseline">
