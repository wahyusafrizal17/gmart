...
<table width="100%" height="127" cellpadding="0" cellspacing="0" class="">
  <tr>
    <th colspan="5" bgcolor="#006666">
      <div class="text-center style1" style="font-size:25px">KWITANSI PEMBELIAN</div>
    </th>
  </tr>
  <tr>
  ...
  ?>
    <tr class="table-striped">
      ...
      <td>
        <div align="left"><?php echo $row_DetailFaktur['qty']; ?> @ Rp. <?php echo $row_DetailFaktur['harga']; ?></div>
      </td>
      <td>
        <div align="right">Rp. <?php echo $sub; ?></div>
      </td>
      <td>
        <div align="right">Rp. <?php echo $row_DetailFaktur['diskon']; ?></div>
      </td>
    </tr>
  <?php
    $no++;
