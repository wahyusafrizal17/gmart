...
$query_Penjualan = sprintf(
  ...
  GetSQLValueString($koneksi, $colname_Penjualan, "text")
);
...
<body onload="window.print();">
  ...
  <div class="row" style="font-size: 16px;">
    ...
    <div class="col-xs-6">
      ...
      <br>ANTRIAN : <?= $row_antrian['antrian']; ?>
    </div>
  </div>
  =============================<br>
  <?php if (!empty($row_faktur['namapelanggan'])) { ?>
    <div class="row" style="font-size: 16px;">
      <div class="col-xs-6">
        <?php echo strtoupper($row_faktur['namapelanggan']); ?>
  ...
  <p align="center"><?= $text2; ?> <br>
    ...
    <?php $cetakan = $row_faktur['qtyprint'] + 1;
    if ($cetakan > 1) {
      echo "This is Copy";
    } else {
      echo "Cetakan ke : " . $cetakan;
    }
    ?> by : <?php echo $row_faktur['Nama']; ?></p>
