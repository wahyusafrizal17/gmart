...
$query_Kasir = sprintf("SELECT Nama FROM vw_login WHERE ID=%s", GetSQLValueString($koneksi, $colname, "text"));
    ...
    <table width="100%" class="table-h">
      ...
      do {
        ...
        $query_DetailFaktur = sprintf("SELECT faktur, tanggal, kode, transaksidetail.nama, harga, qty, diskon, addby, stt, periode, vw_login.Nama as kassa FROM transaksidetail 
				LEFT JOIN vw_login ON addby = vw_login.ID WHERE faktur = %s", GetSQLValueString($koneksi, $row_Penjualan['kodefaktur'], "text"));
