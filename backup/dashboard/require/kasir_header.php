...
$rs_login = mysqli_query($koneksi, $query_rs_login) or die(errorQuery(mysqli_error()));
...
$rs_cab = mysqli_query($koneksi, $query_rs_cab) or die(errorQuery(mysqli_error()));
...
$rs_menu = mysqli_query($koneksi, $query_rs_menu) or die(errorQuery(mysqli_error()));
