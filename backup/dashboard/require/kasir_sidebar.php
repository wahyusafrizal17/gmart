...
$query_rs_search = sprintf("SELECT faktur FROM transaksitemp WHERE faktur = %s", GetSQLValueString($koneksi, $colname_rs_search, "text"));
$rs_search = mysqli_query($koneksi, $query_rs_search) or die(errorQuery(mysqli_error()));
        ...
        <ul class="treeview-menu">
          <li>
            <a href="?page=pengeluaran/view">
              <i class="fa fa-user"></i> PENGELUARAN
              <span class="pull-right-container">
                <small class="label pull-right bg-green">New</small>
              </span>
            </a>
