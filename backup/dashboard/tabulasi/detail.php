    ...
    <div class="table-responsive">
      <table width="100%" height="127" class="table table-bordered table-striped table-hover">
        ...
        <tr>
          ...
          <td>
            <div align="right">Rp. <?php echo number_format($total - $disk); ?> </div>
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          ...
          <td>
            <div align="right">Rp. <?php echo number_format($row_faktur['totalbayar']); ?> </div>
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          ...
          <td>
            <div align="right">Rp. <?php echo number_format($row_faktur['kembalian']); ?></div>
          </td>
        </tr>
      </table>
    </div>
