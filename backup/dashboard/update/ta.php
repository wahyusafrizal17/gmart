...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysqli_query($koneksi, $updateSQL) or die(errorQuery(mysqli_errno($koneksi), mysqli_error()));
}

////mysqli_select_db($database_koneksi);
$query_rs_ta = "SELECT * FROM tb_ta WHERE id_ta = 1";
$rs_ta = mysqli_query($koneksi, $query_rs_ta) or die(errorQuery(mysqli_errno($koneksi), mysqli_error()));
