...
<script type="text/javascript" src="node_modules/webcodecamjs/js/qrcodelib.js"></script>
<script type="text/javascript" src="node_modules/webcodecamjs/js/webcodecamjs.js"></script>
   ...
   <!-- <script type="text/javascript">
            ...
            var arg = {
                resultFunction: function(result) {
                  ...
                  window.location = "welcome.php?cari="+result.code+"&page=produk%2Fview";
                    ...
                    document.getElementById('startButton').addEventListener('click', () => {
                        codeReader.decodeFromVideoDevice(selectedDeviceId, 'video', (result, err) => {
                            if (result) {
                                ...
                                window.location = "welcome.php?cari="+result.text+"&page=produk%2Fview";
                            }
