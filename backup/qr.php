...
$query_rs_print = sprintf("SELECT * FROM tb_paket INNER JOIN tb_pengirim ON pengirim_paket = id_pengirim WHERE kode_paket = %s", GetSQLValueString($koneksi, $colname_rs_print, "text"));
$rs_print = mysqli_query($koneksi, $query_rs_print) or die(errorQuery(mysqli_error()));
