...
$rs_penjualan = mysqli_query($koneksi, $query_rs_penjualan) or die(errorQuery(mysqli_errno($koneksi), mysqli_error()));
...
$rs_item = mysqli_query($koneksi, $query_rs_item) or die(errorQuery(mysqli_errno($koneksi), mysqli_error()));
...
$rs_return = mysqli_query($koneksi, $query_rs_return) or die(errorQuery(mysqli_errno($koneksi), mysqli_error()));
...
$rs_pengeluaran = mysqli_query($koneksi, $query_rs_pengeluaran) or die(errorQuery(mysqli_errno($koneksi), mysqli_error()));
...
$rs_pendapatan = mysqli_query($koneksi, $query_rs_pendapatan) or die(errorQuery(mysqli_errno($koneksi), mysqli_error()));
