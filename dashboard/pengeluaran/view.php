                        ...
                        <table width="100%" class="table table-striped table-bordered">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div align="center"><a href="?page=pengeluaran/update&id=<?= $row_Penjualan['id']; ?>">Edit</a> | <a href="?page=pengeluaran/delete&id=<?= $row_Penjualan['id']; ?>" onclick="return confirm('Anda yakin ingin menghapus transaksi <?php echo  $row_Penjualan['judul']; ?> ini? ')">Hapus</a> </div>
                                    </td>
                                </tr>
                            <?php
                                $no++;
