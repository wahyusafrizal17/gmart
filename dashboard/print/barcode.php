...
<body onLoad="window.print()">
  ...
  <?php do { ?>
    <?php for ($i = 1; $i <= $qty; $i++) { ?>
      <div class="barcode">
        <div align="center">
          <div class="style3"><strong><?php if (!isset($_GET['label'])) { ?><?php echo $row_barcode['namaproduk']; ?>
            <?php } ?></strong></div>
          <font face="code39" size="2em" line-height="5px" style="letter-spacing:3px;">*<?php echo $row_barcode['barcode']; ?>*</font><br />
