...
$query_faktur = sprintf(
  "SELECT faktur.idfaktur, faktur.kodefaktur, faktur.kembalian, faktur.potongan, faktur.totalbayar, vw_login.Nama, faktur.qtyprint FROM faktur 
...
mysqli_select_db($database_koneksi, $koneksi);
$query_antrian = "SELECT COUNT(tglfaktur) as JumlahAntrian, tglfaktur FROM `faktur` WHERE tglfaktur = CURRENT_DATE
GROUP BY tglfaktur";
...
<body onload="window.print();">
  <div class="text-center"><img src="../../assets/barcode/logo-bw.png" width="180px" />
    <br>
    <?= $text1; //$header 
    ?><br>
    <? //$footer; 
  ...
  <div class="row" style="font-size: 16px;">
    ...
    <div class="col-xs-6">
      ...
      <br>ANTRIAN : <?= $row_antrian['JumlahAntrian']++; ?>
    </div>
  </div>
  =============================<br>
      ...
      ?>
        ...
        <tr>
          ...
          <td><?php if ($row_Penjualan['diskon'] > 0) { ?>
              DISK : Rp. <?= $row_Penjualan['diskon']; ?><br>
            <?php } ?></td>
  ...
  <p align="center"><?= $text2; ?> <br>
    ...
    Cetakan ke : <?php echo $row_faktur['qtyprint'] + 1; ?> by : <?php echo $row_faktur['Nama']; ?></p>
