							...
							foreach ($cart_items as $item) { ?>
								<tr style="font-size: 16px; transition: all 0.3s ease;" class="cart-item">
									...
									<td class="text-uppercase">
										<a href="#" data-toggle="modal" data-target="#modal-default<?= $idmodal; ?>" style="text-decoration: none; color: #333;">
											<div style="padding: 10px; border-radius: 10px; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); margin: 5px 0; transition: all 0.3s ease; cursor: pointer;" class="product-item" onmouseover="this.style.transform='scale(1.02)'; this.style.boxShadow='0 5px 15px rgba(0,0,0,0.2)'" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='none'">
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title">DETAIL : <?php echo $item['kode']; ?> - <?php echo $item['nama']; ?></h4>
													</div>
													<div class="modal-body">
																...
																<div class="form-group">
																	...
																	<form id="form<?= $no; ?>" name="formCombobox" method="post" action="">
																		<div class="input-group">
																			<input type="number" name="qtyupdate" value="<?php echo htmlentities($item['qty'], ENT_COMPAT, 'utf-8'); ?>" placeholder="Jumlah Beli" class="form-control input-lg" autofocus />
																			<span class="input-group-btn">
																				<button type="submit" class="btn btn-warning btn-lg">UBAH</button>
																			</span>
																		</div>
																		<input type="hidden" name="MM_update" value="formCombobox" />
																		<input type="hidden" name="kodeCombo" value="<?= $item['kode']; ?>" />
																	</form>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="text" class="form-control input-lg" name="" value="<?php $sub = $item['harga'] * $item['qty'];
														...
														<div class="form-group">
															...
															<form action="<?php echo $editFormAction; ?>" method="post" name="formDiskon" id="formDiskon">
																<div class="input-group">
																	<input type="number" name="diskon" value="<?php echo htmlentities($item['diskon'], ENT_COMPAT, 'utf-8'); ?>" placeholder="Potongan" class="form-control input-lg" autofocus />
																	<span class="input-group-btn">
																...
																<input type="hidden" name="faktur" value="<?= $item['faktur']; ?>" />
															</form>
														</div>
													</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
														<a href="?page=scan/delete&id=<?php echo $item['id'] ?>" class="btn btn-danger btn-flat"><span class="fa fa-close"></span> Hapus</a>
													</div>
												</div>
											</div>
										</div>
