...
<div class="row">
	<div class="col-md-8 col-xs-12">
		<label for="" class="small">SCAN BARCODE HERE</label>
			...
			<table width="100%" class="table table-sm table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td align="right">Rp. <?= number_format($grand); ?></td>
							...
							<table class="table no-border">
								<tr>
									...
									<td><input type="hidden" name="textfield3" id="gt" value="<?= $grand; ?>" />
										<input type="text" name="bayar" id="tunai" placeholder="<?= $grand; ?>" class="form-control input-lg text-right" style="font-size: 45px;" onkeyup="kembalian();" value="<?= $grand; ?>" autofocus />
									</td>
								</tr>
								<tr>
