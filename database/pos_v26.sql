...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Mei 2022 pada 00.55
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
INSERT INTO `barcode` (`id_barcode`, `barcode`, `qtybarcode`, `added`, `addby`, `tercatat`) VALUES
(2, '100004', 1, 1653143355, 1, '2022-05-21 14:30:13');
...
(1, '8991003060219', 25000, 25000, 15000, 'Empeng HUKI', 'Empeng HUKI', 1653146161, 2, '2022-05-21 15:16:01');
...
(8, 'kasir', '*23AE809DDACAF96AF0FD78ED04B6A265E05AA257', 'Kasir', 'Bolai Guguak', '082284980398', 3, 'Y', 1642681857, 0, 2, 'viewpr4t4m4'),
(12, 'sudir', '*31B55B628C040EDC7CEFAE97BCF259D795D8568D', 'Sudir Kasir', 'Jl Karasak cupak\r\n', '082283751455', 3, 'Y', 1653142481, 1653144648, 1, 'viewpr4t4m4');
...
(43, 'Empeng HUKI', 5, NULL, 15000, 25000, '8991003060219', 'pcs', 1, NULL, 'Y', 1653145144, 1653146161, 2, NULL),
(45, 'topi YKS', 4, NULL, 4000, 8000, '070102', 'PCS', 5, NULL, 'Y', 1653146367, 0, 2, NULL),
(46, 'gurita tempel yks', 4, NULL, 22500, 32000, '070101', 'PCS', 1, NULL, 'Y', 1653146412, 0, 2, NULL),
(47, 'topi Nia ', 4, NULL, 7000, 12000, '010405', 'PCS', 33, NULL, 'Y', 1653172487, 0, 2, NULL),
(48, 'turban vinata ', 4, NULL, 7500, 12000, '011504', 'PCS', 21, NULL, 'Y', 1653172518, 0, 2, NULL),
(49, 'empeng lily', 5, NULL, 25000, 35000, '2391852988492', 'PCS', 3, NULL, 'Y', 1653172559, 0, 2, NULL);
...
(4, '43606', '2022-05-21', '100004', 'SANDAL', 35000, 12000, 0, 1, 1653143606, 1, 'GHALIH MASTER', 'Y', '2022');
...
--
ALTER TABLE `harga`
MODIFY `idharga` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
