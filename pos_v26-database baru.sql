...
--
-- Host: 127.0.0.1
-- Generation Time: 02 Jul 2022 pada 03.52
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
(50, 'hits', 4, NULL, 20000, 30000, '8992745140962', 'PCS', 27, NULL, 'Y', 1653913396, 0, 2, NULL);
...
(1, 'G Mart', 'www.instagram.com/ghalihmahdaveqia/', 'KASIR', 'G Mart', 'Jl. Raya Sungai Rotan Cupak (GUDAN)<br>No. HP: 082283751455', 'Maaf Tidak Menjual Rokok <br>- Terima Kasih telah belanja di <br>G-Mart -', 'Y');
...
--
ALTER TABLE `tb_riwayat_login`
MODIFY `id_login` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=181;
--
